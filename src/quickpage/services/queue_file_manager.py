...
class QueueFileManager:
    ...
    async def create_single_queue_file(self, command: FillQueueCommand) -> Result[str, str]:
    ...
    async def create_batch_queue_files(self, command: FillQueueCommand, neuron_types: List[str]) -> Result[str, str]:
