...
class IndexGeneratorService:
    ...
    async def generate_neuron_search_js(self, output_dir: Path, neuron_data: List[Dict[str, Any]], generation_time) -> None:
    ...
    async def generate_readme(self, output_dir: Path, template_data: Dict[str, Any]) -> None:
    ...
    async def generate_help_page(self, output_dir: Path, template_data: Dict[str, Any], uncompress: bool = False) -> None:
    ...
    async def generate_index_page(self, output_dir: Path, template_data: Dict[str, Any], uncompress: bool = False) -> None:
    ...
    def calculate_totals(self, index_data: List[Dict[str, Any]], cached_data_lazy=None) -> Dict[str, int]:
    ...
    def group_neuron_types_by_roi(self, index_data: List[Dict[str, Any]], roi_hierarchy_service) -> List[Dict[str, Any]]:
        ...
        for entry in index_data:
            ...
            if parent_roi != 'Other':
                parent_roi = roi_hierarchy_service._clean_roi_name(parent_roi) or 'Other'
