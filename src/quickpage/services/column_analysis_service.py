...
class ColumnAnalysisService:
    ...
    def _extract_column_information(self, column_rois: pd.DataFrame,
                                   column_pattern: str) -> List[Dict[str, Any]]:
    ...
    def _analyze_column_data(self, roi_info: List[Dict[str, Any]], neuron_type: str,
    ...
    def _generate_column_summary_statistics(self, column_summary: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def _update_neuron_type_columns_cache(self, neuron_type: str, column_summary: List[Dict[str, Any]],
        ...
        self.page_generator._neuron_type_columns_cache[neuron_cache_key] = (column_summary, region_columns_map)
