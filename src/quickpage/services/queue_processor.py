...
class QueueProcessor:
    ...
    async def pop_and_process_queue(self, command: PopCommand) -> Result[str, str]:
        ...
        try:
            ...
            try:
                ...
                # Process the command
                result = await self._process_generate_command(generate_command, stored_config_file)
    ...
    async def _process_generate_command(self, generate_command: GeneratePageCommand, stored_config_file: str = None) -> Result[str, str]:
