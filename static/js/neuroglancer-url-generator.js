  ...
  layers: [
    ...
    },
    {
      ...
      source: {
        ...
        transform: {
          outputDimensions: { x: [8e-9, "m"], y: [8e-9, "m"], z: [8e-9, "m"] },
        },
      },
      tool: "annotatePoint",
      tab: "annotations",
    ...
    },
    {
      type: "annotation",
      source:
        "dvid://https://emdata-mcns.janelia.org/f3969:master/segmentation_todo",
      tab: "rendering",
    ...
    },
    {
      type: "segmentation",
      source: {
        url: "dvid://https://emdata-mcns.janelia.org/f3969dc575d74e4f922a8966709958c8/segmentation?dvid-service=https://ngsupport-bmcp5imp6q-uk.a.run.app",
    ...
    },
    {
      type: "segmentation",
      source: {
        url: "precomputed://gs://flyem-cns-roi-7c971aa681da83f9a074a1f0e8ef60f4/ME(R)-columns-v7",
        subsources: { default: true, properties: true, mesh: true },
        enableDefaultSubsources: false,
      },
      pick: false,
    ...
    },
    {
      type: "segmentation",
      source: {
        url: "precomputed://gs://flyem-cns-roi-7c971aa681da83f9a074a1f0e8ef60f4/ME(R)-layers-v7",
        subsources: { default: true, properties: true, mesh: true },
        enableDefaultSubsources: false,
      },
      pick: false,
    ...
    },
    {
      type: "segmentation",
      source: {
        url: "precomputed://gs://flyem-cns-roi-7c971aa681da83f9a074a1f0e8ef60f4/LO(R)-columns-v7",
        subsources: { default: true, properties: true, mesh: true },
        enableDefaultSubsources: false,
      },
      pick: false,
    ...
    },
    {
      type: "segmentation",
      source: {
        url: "precomputed://gs://flyem-cns-roi-7c971aa681da83f9a074a1f0e8ef60f4/LO(R)-layers-v7",
        subsources: { default: true, properties: true, mesh: true },
        enableDefaultSubsources: false,
      },
      pick: false,
    ...
    },
    {
      type: "segmentation",
      source: {
        url: "precomputed://gs://flyem-cns-roi-7c971aa681da83f9a074a1f0e8ef60f4/LOP(R)-columns-v7",
        subsources: { default: true, properties: true, mesh: true },
        enableDefaultSubsources: false,
      },
      pick: false,
    ...
    },
    {
      type: "segmentation",
      source: {
        url: "precomputed://gs://flyem-cns-roi-7c971aa681da83f9a074a1f0e8ef60f4/LOP(R)-layers-v7",
        subsources: { default: true, properties: true, mesh: true },
        enableDefaultSubsources: false,
      },
      pick: false,
    ...
    },
    {
      type: "segmentation",
      source: {
        url: "precomputed://gs://flyem-cns-roi-7c971aa681da83f9a074a1f0e8ef60f4/ME(L)-columns-v1",
        subsources: { default: true, properties: true, mesh: true },
        enableDefaultSubsources: false,
      },
      pick: false,
    ...
    },
    {
      type: "segmentation",
      source: {
        url: "precomputed://gs://flyem-cns-roi-7c971aa681da83f9a074a1f0e8ef60f4/ME(L)-layers-v1",
        subsources: { default: true, properties: true, mesh: true },
        enableDefaultSubsources: false,
      },
      pick: false,
    ...
    },
    {
      type: "segmentation",
      source: {
        url: "precomputed://gs://flyem-cns-roi-7c971aa681da83f9a074a1f0e8ef60f4/LO(L)-columns-v1",
        subsources: { default: true, properties: true, mesh: true },
        enableDefaultSubsources: false,
      },
      pick: false,
    ...
    },
    {
      type: "segmentation",
      source: {
        url: "precomputed://gs://flyem-cns-roi-7c971aa681da83f9a074a1f0e8ef60f4/LO(L)-layers-v1",
        subsources: { default: true, properties: true, mesh: true },
        enableDefaultSubsources: false,
      },
      pick: false,
    ...
    },
    {
      type: "segmentation",
      source: {
        url: "precomputed://gs://flyem-cns-roi-7c971aa681da83f9a074a1f0e8ef60f4/LOP(L)-columns-v1",
        subsources: { default: true, properties: true, mesh: true },
        enableDefaultSubsources: false,
      },
      pick: false,
    ...
    },
    {
      type: "segmentation",
      source: {
        url: "precomputed://gs://flyem-cns-roi-7c971aa681da83f9a074a1f0e8ef60f4/LOP(L)-layers-v1",
        subsources: { default: true, properties: true, mesh: true },
        enableDefaultSubsources: false,
      },
      pick: false,
    ...
    },
    {
      type: "segmentation",
      source: {
        url: "precomputed://gs://flyem-cns-roi-7c971aa681da83f9a074a1f0e8ef60f4/OL(R)-v0",
        subsources: { default: true, properties: true, mesh: true },
        enableDefaultSubsources: false,
      },
      pick: false,
    ...
    },
    {
      type: "segmentation",
      source: {
        url: "precomputed://gs://flyem-cns-roi-7c971aa681da83f9a074a1f0e8ef60f4/OL(R)-release",
        subsources: { default: true, properties: true, mesh: true },
        enableDefaultSubsources: false,
      },
      pick: false,
    ...
    },
    {
      type: "segmentation",
      source:
        "precomputed://https://flyem.mrc-lmb.cam.ac.uk/flyconnectome/hemibrain2mcns",
      tab: "segments",
