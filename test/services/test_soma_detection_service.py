...
class TestSomaDetectionService:
    ...
    @pytest.mark.asyncio
    async def test_analyze_soma_sides_single_side_no_combined(self, detection_service, mock_dependencies):
        ...
        mock_dependencies['neuron_statistics_service'].get_soma_side_distribution = AsyncMock(return_value=Ok({
            'left': 5,
            'right': 0,
            'middle': 0,
            'total': 5
        ...
        assert result['should_generate_combined'] == False

    @pytest.mark.asyncio
    async def test_analyze_soma_sides_multiple_sides_generates_combined(self, detection_service, mock_dependencies):
        ...
        assert result['should_generate_combined'] == True

    @pytest.mark.asyncio
    async def test_analyze_soma_sides_single_side_with_unknown_generates_combined(self, detection_service, mock_dependencies):
    ...
    @pytest.mark.asyncio
    async def test_analyze_soma_sides_no_sides_with_neurons_generates_combined(self, detection_service, mock_dependencies):
    ...
    @pytest.mark.asyncio
    async def test_analyze_soma_sides_middle_only_no_combined(self, detection_service, mock_dependencies):
    ...
    @pytest.mark.asyncio
    async def test_analyze_soma_sides_right_only_no_combined(self, detection_service, mock_dependencies):
    ...
    @pytest.mark.asyncio
    async def test_analyze_soma_sides_error_handling(self, detection_service, mock_dependencies):
        """Test error handling in analyze_soma_sides."""
        # Mock neuron statistics service to return error
        mock_dependencies['neuron_statistics_service'].get_soma_side_distribution = AsyncMock(return_value=Err("Database connection failed"))
    ...
    @pytest.mark.asyncio
    async def test_analyze_soma_sides_left_and_middle_generates_combined(self, detection_service, mock_dependencies):
