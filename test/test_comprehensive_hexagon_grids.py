...
def main():
    ...
    print(f"- ME region columns: {len(region_columns_map['ME'])}")
    print(f"- LO region columns: {len(region_columns_map['LO'])}")
    print(f"- LOP region columns: {len(region_columns_map['LOP'])}")
