...
def test_tm3_neuron_type_exists():
    ...
    try:
        ...
        assert "Tm3" in available_types, f"Tm3 not found in {len(available_types)} available neuron types"

        print(f"SUCCESS: Tm3 found in database with {len(available_types)} total neuron types")
